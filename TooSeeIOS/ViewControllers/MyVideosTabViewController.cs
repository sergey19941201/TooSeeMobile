...
{
    public partial class MyVideosTabViewController : UIViewController
    {
        public MyVideosTabViewController(IntPtr handle) : base (handle)
        {
        ...
        {
            base.ViewDidLoad();
            // Perform any additional setup after loading the view, typically from a nib.my
