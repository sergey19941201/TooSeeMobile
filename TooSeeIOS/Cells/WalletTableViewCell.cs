...
{
    public class WalletTableViewCell : UITableViewCell
    {
        bool _isExpanded;
		...
		protected UILabel AmountLabel { get; }
		protected UILabel dateLabel { get; }
		protected UILabel serviceFeeLabel { get; }
		protected UILabel infoLabel { get; }
		protected UILabel contactLabel { get; }
        ...
        public WalletTableViewCell(IntPtr handle) : base(handle)
        {
			...
			ContentView.AddSubviews(AmountLabel, serviceFeeLabel, infoLabel, dateLabel, contactLabel, ExpandImageView);
            ContentView.AddConstraints(new[]
            {
                AmountLabel.TopAnchor.ConstraintEqualTo(ContentView.TopAnchor, 16),
                AmountLabel.BottomAnchor.ConstraintEqualTo(serviceFeeLabel.TopAnchor, -16),
                ...
                ServiceFeeLabelBottomConstraint = serviceFeeLabel.BottomAnchor.ConstraintEqualTo(ContentView.BottomAnchor),
                ServiceFeeLabelHeightConstraint = serviceFeeLabel.HeightAnchor.ConstraintEqualTo(0),
				...
				serviceFeeLabel.LeadingAnchor.ConstraintEqualTo(ContentView.LeadingAnchor, ContentView.Frame.Width-dateLabel.Frame.Width-dataWidthConstraint),
				serviceFeeLabel.TrailingAnchor.ConstraintEqualTo(ContentView.TrailingAnchor, -16),
